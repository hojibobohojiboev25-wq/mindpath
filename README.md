...
- ✅ Анализ личности (демо версия)
- ✅ Генерация карт мышления
...
4. **Консоль браузера:**
   ...
   - Ищите ошибки загрузки скрипта

5. **Проверка виджета:**
   - Виджет должен загружаться автоматически
   - Если видите "Username invalid" - проблема с username бота
   - Если видите "Конфигурация бота не завершена" - проблема с переменной окружения
